...
private:
    ...
    //powerhd
    static constexpr float SERVO_PULSE_MIN_powerhd = 0.30175f;
    static constexpr float SERVO_PULSE_MAX_powerhd = 0.695f;   
    // Werte fuer 333 Hz (Berechnet für 428us - 1072us Pulsweite)
    static constexpr float SERVO_PULSE_MIN = 0.1425f;
    static constexpr float SERVO_PULSE_MAX = 0.3570f;
    ...
    // michi 24.04
    // static constexpr float BALL_CTRL_KP = 0.8f * 0.2383 * 0.3f; //0.2f;
    // static constexpr float BALL_CTRL_KI = 0.0f;
    // static constexpr float BALL_CTRL_TAU_V = 4.3850f;//4.5f;//0.06f * 1.0f;//0.1314f * 0.1; //0.0413f * 1.0f;
    ...
    // static constexpr float BALL_CTRL_KD = 0.8f * 0.29f;
    // static constexpr float VISION_TIMEOUT = 1.0F; // seconds
